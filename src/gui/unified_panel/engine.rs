                        ...
                        if ui
                            ...
                            .clicked()
                            {
                                    ...
                                    .pick_file()
                                {
                                    ...
                                    *selected_resampler = crate::drivers::KnownResampler::ALL
                                        .into_iter()
                                        .find(|profile| profile.executable_names().iter().any(|candidate| candidate.eq_ignore_ascii_case(name)))
                                        .map(|profile| profile.label().to_string())
                                        .unwrap_or_else(|| "Personalizado (UTAU CLI)".to_string());
                ...
                .show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        if ui
                            .radio_value(
                                ...
                                lang.tr("Galapagos (Recomendado)", "Galapagos (Recommended)"),
                            )
                            .clicked()
                        {
                    ...
                    ui.horizontal(|ui| {
                        if ui
                            .radio_value(
                                selected_wavtool,
                                "Andromeda (Alternativo)".to_string(),
                                lang.tr("Andromeda (Alternativo)", "Andromeda (Alternative)"),
                            )
                            .clicked()
                        {
                            *custom_wavtool_path = None;
