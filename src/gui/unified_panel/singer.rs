            ...
            Frame::none()
                ...
                .show(ui, |ui| {
                    ...
                    ui.columns(3, |cols| {
                        ...
                        {
                            vocal_mode_params
                                .apply_preset(crate::renderer::VocalRenderPreset::Organic);
                        }
                        if cols[1]
                            .add_sized(
                            ...
                            .clicked()
                        {
                            vocal_mode_params.apply_preset(crate::renderer::VocalRenderPreset::Pop);
                        }
                        if cols[2]
                            .add_sized(
                        ...
                        {
                            vocal_mode_params
                                .apply_preset(crate::renderer::VocalRenderPreset::Robotic);
                        }
                    });
                });
        });
