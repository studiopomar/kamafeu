...
pub fn draw_arrangement_view(
    ...
    ui.vertical(|ui| {
        ...
        let total_tracks_h =
            (tracks.len() as f32 * track_height + ruler_height).clamp(110.0, 220.0);
                ...
                for (idx, track) in tracks.iter_mut().enumerate() {
                    ui.push_id(idx, |ui| {
                        ...
                        ui.horizontal(|ui| {
                            ...
                            ui.painter()
                                .rect_stroke(card_rect, Rounding::same(4.0), card_stroke);
                            ...
                            // Track volume and stereo pan controls.
                            ...
                            ui.allocate_new_ui(egui::UiBuilder::new().max_rect(vol_rect), |ui| {
                                ui.horizontal(|ui| {
                                    ...
                                    ui.add(
                                        egui::Slider::new(&mut track.volume_db, -20.0..=6.0)
                                            .show_value(false),
                                    );
                                    ui.label(
                            ...
                            let scroll_id =
                                ui.make_persistent_id(("arrangement_timeline_h_scroll", idx));
                            ...
                            egui::ScrollArea::horizontal()
                                ...
                                .show(ui, |ui| {
                                    let (strip_rect, strip_resp) = ui.allocate_exact_size(
                                        Vec2::new(available_width.max(5000.0), card_total_h),
