...
pub struct PianoRollState {
    pub timbre_drag: Option<Pos2>,
    pub timbre_changed: bool,
...
impl PianoRollState {
    ...
    pub fn merge_rendered_waveform(
        &mut self,
        samples: &[f32],
        sample_rate: u32,
        channels: u16,
        ...
        let chunk_end = chunk_state.rendered_waveform_peaks.last().unwrap().0;
        self.rendered_waveform_peaks
            .retain(|(time_ms, _, _)| *time_ms < chunk_start || *time_ms > chunk_end);
        self.rendered_waveform_peaks
    ...
    pub fn append_rendered_waveform(
        ...
        self.merge_rendered_waveform(samples, sample_rate, channels, start_offset_ms);
    }
