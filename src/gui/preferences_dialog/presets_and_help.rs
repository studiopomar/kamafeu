...
impl KamafeuStudioApp {
    pub(in crate::gui) fn render_presets_and_help_tab(&mut self, ui: &mut egui::Ui) {
        ...
        section_card(
            ui,
            lang.tr("Predefinições de desempenho", "Performance Presets"),
            |ui| {
                ui.label(
                ...
                ui.columns(3, |columns| {
                    columns[0].vertical(|ui| {
                        ...
                        if ui
                            .button(lang.tr("Aplicar equilibrado", "Apply balanced"))
                            .clicked()
                        {
                    ...
                    columns[1].vertical(|ui| {
                        ...
                        if ui
                            .button(lang.tr("Aplicar baixa latência", "Apply low latency"))
                            .clicked()
                        {
                    ...
                    columns[2].vertical(|ui| {
                        ...
                        if ui
                            .button(lang.tr("Aplicar projeto pesado", "Apply heavy project"))
                            .clicked()
                        {
        ...
        section_card(
            ui,
            lang.tr("O que cada componente faz", "What Each Component Does"),
            |ui| {
                let references = [
                (
