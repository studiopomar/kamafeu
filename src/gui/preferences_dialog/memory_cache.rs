...
impl KamafeuStudioApp {
    pub(in crate::gui) fn render_memory_cache_tab(&mut self, ui: &mut egui::Ui) {
        ...
        section_card(ui, lang.tr("Estatísticas de Cache em Disco & Memória RAM", "Disk Cache & RAM Memory Statistics"), |ui| {
        ...
        section_card(ui, lang.tr("Limites e Políticas de Armazenamento", "Limits and Storage Policies"), |ui| {
            ui.horizontal(|ui| {
            ...
            ui.horizontal(|ui| {
                ui.label(lang.tr("Limite Máximo de Armazenamento em Disco:", "Maximum Disk Storage Limit:"));
                ui.add(
            ...
            ui.add_space(4.0);
            ui.horizontal(|ui| {
                ui.label(lang.tr("Resolução do Cache de Forma de Onda:", "Waveform Cache Resolution:"));
                ui.add(
