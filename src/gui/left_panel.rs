                    ...
                    .show(ui, |ui| {
                        ...
                        egui::ComboBox::from_id_salt("phonemizer_mode_cb")
                            .selected_text(match params.phonemizer_mode {
                                ...
                                crate::phonemizer::PhonemizerMode::BasicCV => "JA: CV(VV)",
                                ...
                                crate::phonemizer::PhonemizerMode::EnglishArpasing => {
                                    "EN: English Arpasing (Fonética)"
                                }
                                crate::phonemizer::PhonemizerMode::EnglishVCCV => {
                                    "EN: English VCCV (Fonética)"
                                }
                        ...
                        ui.label(
                            RichText::new("Sobreposição (Fonemas)").color(theme.text_muted_c32()),
                        );
                        ui.add(
                        ...
                        ui.horizontal(|ui| {
                            if ui.button(RichText::new("Orgânico").size(10.0)).clicked() {
                                params.apply_preset(crate::renderer::VocalRenderPreset::Organic);
                            }
                            if ui.button(RichText::new("Pop Natural").size(10.0)).clicked() {
                                params.apply_preset(crate::renderer::VocalRenderPreset::Pop);
                            }
                            if ui
                                .button(RichText::new("Direto / Robótico").size(10.0))
                                .clicked()
                            {
                                params.apply_preset(crate::renderer::VocalRenderPreset::Robotic);
                            }
                        });
                    });
            }
