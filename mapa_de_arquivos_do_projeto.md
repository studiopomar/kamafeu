...
| `src/gui/inspector.rs` | Painel inspetor lateral direito: propriedades da nota selecionada, parâmetros do oto.ini e expressões dinâmicas. |
...
## `src/oto/` — Sistema de Calibração do oto.ini e Voicebanks

| Arquivo | Descrição |
| --- | --- |
| `src/oto/mod.rs` | Módulo raiz do subsistema de oto.ini. |
